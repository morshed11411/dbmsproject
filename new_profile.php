                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                <h6><?php echo $basic->em_email; ?></h6> <small class="text-muted p-t-30 db">Mobile</small>
                                ...
                                <a class="btn btn-circle btn-secondary" href="<?php if(!empty($socialmedia->google_Plus)) echo $socialmedia->google_Plus ?>" target="_blank"><i class="fa fa-google"></i></a>
				                                ...
				                                <form class="row" action="Update" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group col-md-2 m-t-20">
                                                        ...
                                                        <select name="Appointment" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> value="<?php echo $basic->em_blood_group; ?>" class="form-control custom-select">
                                                            <option value="<?php echo $basic->appointment; ?>"><?php echo $basic->appointment; ?></option> 
                                                   ...
                                                   <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>  <?php } else { ?> 
                                                    <div class="form-group col-md-4 m-t-10">
                                                        ...
                                                        <select name="role" class="form-control custom-select" required >
                                                            ...
                                                            <option value="EMPLOYEE">Soldier</option>
