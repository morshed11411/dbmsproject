...
CREATE TABLE SOLDIER (
  ...
  RANKID NUMBER,
  COMPANYID NUMBER,
  FOREIGN KEY (COMDID) REFERENCES TEMPORARYCOMMAND(COMDID),
  FOREIGN KEY (EREID) REFERENCES ERE(EREID),
...
INSERT INTO SOLDIER (SOLDIERID, NAME)
VALUES (12345, 'Admin');
INSERT INTO LOGIN (SOLDIERID, PASSWORD, ROLE)
...
CREATE TABLE CARRIERPLAN (
  SOLDIERID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
